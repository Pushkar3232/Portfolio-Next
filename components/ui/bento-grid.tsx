...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento row-span-1 flex flex-col justify-between rounded-2xl border border-border bg-card text-foreground p-5 shadow-sm transition-all duration-300 hover:shadow-xl hover:border-border/70 hover:-translate-y-1",
        className
      )}
    >
